...
const ArchivedBlogs = () => {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            toast.success("Archived blog deleted.");
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                <div>
                    ...
                    <p className="mt-2 text-gray-500">
                        ...
                        Archived blogs are hidden from the website but safely stored.
                ...
                <div className="relative w-full md:w-80">
                    ...
                    <input
                        type="text"
                        placeholder="Search archived blogs..."
                        value={search}
